...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        if SummonUserContext.me != nil {
            ...
            print("is it connected? \(SocketIOManager.sharedInstance.socket.status)")
            SocketIOManager.sharedInstance.attempt_reconnect()
            SocketIOManager.sharedInstance.send(event_name: "request_incoming_summons", items: data)
            print("Just requested queued summons 3")
        }
    }
